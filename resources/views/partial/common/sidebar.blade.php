        ...
        <div class="info">
            ...
            @else
                <a href="#" class="d-block"
                    style="color: #fd7e14">{{ App\Model\Common\User::find(Auth::user()->id)->name }}</a>
            @endif
        </div>
    </div>
    <!-- Sidebar Menu -->
    <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-legacy nav-flat" data-widget="treeview" role="menu"
            ...
            <li class="nav-item has-treeview menu-open">
                <a href="{{ route('dash') }}"
                    class="nav-link {{ request()->is('admin/common/dashboard') ? 'active' : '' }}">
            ...
            <li
                class="nav-item has-treeview  {{ request()->is('admin/abouts') ||
                ...
                <a href="{{ route('abouts.edit') }}"
                    class="nav-link {{ request()->is('admin/abouts') ||
                    request()->is('admin/video-block') ||
                    request()->is('admin/news-block*') ||
                    request()->is('admin/abouts*')
                        ? 'active'
            ...
            {{-- <li
                class="nav-item has-treeview  {{ request()->is('admin/rooms') || request()->is('admin/rooms*') || request()->is('admin/category-special*')
                    ? 'menu-open'
                    : '' }} ">
                <a href="#"
                    class="nav-link {{ request()->is('admin/rooms') || request()->is('admin/rooms*') || request()->is('admin/category-special*') ? 'active' : '' }}">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="{{ route('category_special.index') }}"
                            class="nav-link {{ Request::routeIs('category_special.index') ? 'active' : '' }}">
                            <i class="far fas  fa-angle-right nav-icon"></i>
                    ...
                    <li class="nav-item">
                        <a href="{{ route('Room.index') }}"
                            class="nav-link {{ Request::routeIs('Room.index') ? 'active' : '' }}">
                            <i class="far fas  fa-angle-right nav-icon"></i>
                    ...
                    <li class="nav-item">
                        <a href="{{ route('Room.create') }}"
                            class="nav-link {{ Request::routeIs('Room.create') ? 'active' : '' }}">
                            <i class="far fas  fa-angle-right nav-icon"></i>
            ...
            <li
                class="nav-item has-treeview  {{ request()->is('admin/services') || request()->is('admin/services/*') || request()->is('admin/services') || request()->is('admin/services/*') ? 'menu-open' : '' }} ">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="{{ route('ServiceCategory.index') }}"
                            class="nav-link {{ Request::routeIs('ServiceCategory.index') ? 'active' : '' }}">
                            <i class="far fas  fa-angle-right nav-icon"></i>
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="{{ route('amenities.index') }}"
                            class="nav-link {{ Request::routeIs('amenities.index') ? 'active' : '' }}">
                            <i class="far fas  fa-angle-right nav-icon"></i>
                            <p>Danh mục album ảnh</p>
                        </a>
                    </li>
                </ul>
            </li> --}}
            ...
            <li
                ...
                <a href="#"
                    class="nav-link {{ request()->is('admin/posts') || request()->is('admin/posts/*') || request()->is('admin/post-categories') || request()->is('admin/post-categories/*') ? 'active' : '' }}">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="{{ route('PostCategory.index') }}"
                            class="nav-link {{ Request::routeIs('PostCategory.index') ? 'active' : '' }}">
                            <i class="far fas  fa-angle-right nav-icon"></i>
                            <p>Danh mục</p>
                        </a>
                    </li>
            ...
            <li
                class="nav-item has-treeview  {{ request()->is('admin/contacts') || request()->is('admin/contact-banner') ? 'menu-open' : '' }} ">
                <a href="#" class="nav-link">
                ...
                <ul class="nav nav-treeview">
                    {{-- <li class="nav-item">
                        <a href="{{ route('contactPages.edit') }}"
                            class="nav-link {{ Request::routeIs('contactPages.edit') ? 'active' : '' }}">
                            <i class="far fas  fa-angle-right nav-icon"></i>
                            <p>Cấu hình banner</p>
                        </a>
                    </li> --}}
            ...
            <li
                class="nav-item has-treeview  {{ request()->is('admin/stores') || request()->is('admin/banners') || request()->is('admin/origins') || request()->is('admin/manufacturers/*') || request()->is('admin/attributes') ? 'menu-open' : '' }} ">
                ...
                <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item has-treeview">
                        <a href="{{ route('Review.index') }}"
                            class="nav-link {{ Request::routeIs('Review.index') ? 'active' : '' }}">
                            <i class="far fas  fa-angle-right nav-icon"></i>
                            <p>
                                Đánh giá khách hàng
                            </p>
