    ...
    <div class="col-lg-8">
        <div class="custom-card">
            ...
            <div class="form-group custom-group mb-4">
                ...
                <textarea rows="4" class="form-control ck-editor" ck-editor ng-model="form.intro_text"></textarea>
                <div class="invalid-feedback d-block"><% errors.intro_text[0] %></div>
            </div>

            <div class="form-group custom-group mb-4">
                <label class="form-label required-label">Nội dung</label>
                <textarea rows="4" class="form-control ck-editor" ck-editor ng-model="form.body_text"></textarea>
                <div class="invalid-feedback d-block"><% errors.body_text[0] %></div>
            </div>

            <div class="">
                <label class="form-label">Tiêu chí</label>
                <button class="btn btn-sm btn-primary" style="margin-bottom: 10px; float: right;" ng-click="form.addResult()">
                    <i class="fa fa-plus mr-0"></i> Thêm tiêu chí
                </button>
                <div class="custom-group" style="width: 100%; margin-top: 20px;" ng-repeat="item in form.results track by $index">
                    <div class="d-flex">
                        <input type="text" class="form-control" style="width: 90%;" ng-model="item.title">
                        <button class="btn btn-sm btn-danger" style="float: right;" ng-click="form.removeResult($index)">
                            <i class="fa fa-times mr-0"></i>
                        </button>
                    </div>
                    <div class="invalid-feedback d-block"><% errors.results[$index].title[0] %></div>
                </div>
            ...
            <div class="card-body">
                ...
                <div class="form-group text-center">
                    <div class="main-img-preview">
                        <label class="required-label">Ảnh giám đốc</label>
