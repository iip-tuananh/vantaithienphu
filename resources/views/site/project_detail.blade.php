...
@section('title')
    {{ $project->name }} - {{ $config->web_title }}
@endsection
@section('description')
    {{ strip_tags(html_entity_decode($config->introduction)) }}
@endsection
@section('image')
    {{ @$project->image ? $project->image->path : $config->image->path }}
@endsection
                ...
                <div class="wptb-project--inner">
                    <div class="wptb-heading">
                        <div class="wptb-item--inner text-center">
                            ...
                            <h1 class="wptb-item--title" style="font-size: 35px; margin-top: 0px;"> <span>{{ $project->name }}</span>
                            </h1>
                        </div>
                    </div>
                            ...
                            @foreach ($project->galleries as $gallery)
                                <div class="grid-item box-hover">
                                    <div class="wptb-item--inner">
                                        <div class="wptb-item--image" style="border-radius: 0;">
