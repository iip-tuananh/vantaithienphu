...
<body class="custom-cursor" ng-app="App">
    ...
    {{-- <div id="chat-popup" class="chat-popup" ng-controller="PopupContactPage">
        <div class="popup-inner">
            ...
            <div class="chat-form">
                ...
                <form class="contact-form-validated" id="popup-form-contact">
    ...
    <a target="_blank" class="call-hotline" href="tel:{{$config->hotline}}">
    ...
    <a target="_blank" class="livechat-zalo" href="https://zalo.me/{{$config->zalo}}">
        <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <a target="_blank" class="livechat-messenger" href="{{$config->facebook}}">
        <img src="/site/images/messenger.svg" alt="Messenger" width="45" height="45" loading="lazy">
    </a>
    <style>
        .call-hotline {
            position: fixed;
    ...
    <script>
        app.controller('PopupContactPage', function($rootScope, $scope, $sce, $interval) {
            ...
            $scope.submitContact = function() {
                ...
                var data = jQuery('#popup-form-contact').serialize();
                $scope.loading = true;
                jQuery.ajax({
                    type: 'POST',
                    url: url,
